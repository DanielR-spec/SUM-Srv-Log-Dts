...
public class LczCarrtioLg {
	 ...
	 * @param args
	 */
	public ServiciosLogicaCarritoRemote getRemoteFachadaLogica() throws NamingException {
	 ...
	 * @param args
	 */
	private ServiciosLogicaCarritoRemote lookupFachadaLogicaBean(String namespace) throws NamingException {
		Context ctx = createInitialContextlog();
		String appName = "TierLogica";
		String moduleName = "ServiciosLogica";
		String distinctName = "";
		String beanName = "ServiciosLogicaCarrito";
		String viewClassName = "com.logic.services.ServiciosLogicaCarritoRemote";
		return (ServiciosLogicaCarritoRemote) ctx.lookup(namespace + appName + "/" + moduleName + "/" + distinctName + "/" + beanName + "!" + viewClassName);
	}
