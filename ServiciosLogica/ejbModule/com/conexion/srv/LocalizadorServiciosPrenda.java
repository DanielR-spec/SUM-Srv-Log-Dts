...
public class LocalizadorServiciosPrenda {

	public LocalizadorServiciosPrenda() {
	 ...
	 * @param args
	 */
	public ServiciosPrendaRemote getRemoteFachadaLogica() throws NamingException {
	 ...
	 * @param args
	 */
	private ServiciosPrendaRemote lookupFachadaLogicaBean(String namespace) throws NamingException {
		Context ctx = createInitialContextlog();
		String appName = "TierDatos";
		String moduleName = "ServiciosDatos";
		String distinctName = "";
		String beanName = "ServiciosPrenda";
		String viewClassName = "com.data.services.ServiciosPrendaRemote";
		return (ServiciosPrendaRemote) ctx.lookup(namespace + appName + "/" + moduleName + "/" + distinctName + "/" + beanName + "!" + viewClassName);
	}
